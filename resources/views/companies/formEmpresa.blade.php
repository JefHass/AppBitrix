...
<head>
 ...
 <div class="container">
   ...
   <div id="formEmpresa">
    <form action="/companies" method="post" id="formcontato">
        @csrf
    <fieldset>
        <fieldset class="grupo">
            <div class="campo">
                <label for="eName">Nome Da Empresa</label>
                <input type="text" id="eName" name="eName" style="width: 10em" value="" >
            </div>
        </fieldset>

        <div class="campo">
            <label for="eEmail">E-mail</label>
            <input type="text" id="eEmail" name="eEmail" style="width: 20em" value="" >
        </div>
        <div class="campo">
            <label for="ePhone">Telefone</label>
            <input type="text" id="ePhone" name="ePhone" style="width: 10em" value="" >
        </div>
