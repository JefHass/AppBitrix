...
<div class="">
    <div class="row">
        <div id="info-container" class="">
            ...
            <h2>Telefone: {{ $company->ePhone }}</h2>
            <h2>E-mail: {{ $company->eEmail }}</h2>
            <h2>Endereço: {{ $company->eEmail }}</h2>
        </div>
    </div>
</div>
<a href="/companies/edit/{{$company->id}}" class="btn third">Editar</a>
<form action="/companies/{{$company->id}}" method="POST">
    @method('DELETE')
    <button type="submit" class="btn first" name="thash-outline">Deletar</button>
</form>
<body>
