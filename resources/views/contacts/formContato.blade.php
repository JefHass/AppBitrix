...
<head>
 ...
 <div class="container">
   ...
   <div id="formContato">
    <form action="/contacts" method="post" id="formcontato">
        @csrf
    <fieldset>
        <fieldset class="grupo">
            <div class="campo">
                <label for="cName">Nome</label>
                <input type="text" id="cName" name="cName" style="width: 10em" value="" required>
            </div>
            <div class="campo">
                <label for="cLastName">Sobrenome</label>
                <input type="text" id="cLastName" name="cLastName" style="width: 10em" value="" required>
            </div>
        </fieldset>

        <div class="campo">
            <label for="cEmail">E-mail</label>
            <input type="text" id="cEmail" name="cEmail" style="width: 20em" value="" required>
        </div>
        <div class="campo">
            <label for="cPhone">Telefone</label>
            <input type="text" id="cPhone" name="cPhone" style="width: 10em" value="" required>
        </div>
    ...
    <body>
    <button class="btn third" onclick="goBack()">Cancelar</button>
    </body>
</div>
</div>
